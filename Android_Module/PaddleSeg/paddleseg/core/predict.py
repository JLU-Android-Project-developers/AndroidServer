...
def predict(model,
    ...
    cropped_saved_dir = save_dir
    #os.path.join(save_dir, 'cropped_prediction')
    ...
    with paddle.no_grad():
        for i, im_path in enumerate(img_lists[local_rank]):
            ...
            # save cropped image
            cropped_image = utils.visualize.crop(im_path, pred)
            cropped_image_path = os.path.join(cropped_saved_dir, im_file)
